...
FloatingWindow {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            Quickshell.execDetached(["bash", "-c", `hyprctl dispatch resizewindowpixel "exact ${t.w} ${t.h},title:^(qs-master)$" && hyprctl dispatch movewindowpixel "exact ${t.x} ${t.y},title:^(qs-master)$" && hyprctl dispatch focuswindow title:^qs-master$ && hyprctl dispatch bringactivetotop`]);
